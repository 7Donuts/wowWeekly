...
const VERSIONS = [
  ...
  },
  {
    ...
    entries: [
      { type: 'new',     text: 'BiS Gear button in the toolbar opens a picker to browse and import Best in Slot items by class and spec', detail: 'Pick your class and spec, browse the full gear list, check what you want, and import. Items land in Your List under their own BiS section.' },
