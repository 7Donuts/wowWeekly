...
const SECTIONS = [
...

  {
    ...
    url: 'https://www.wowhead.com/guides/vanity-collections/mounts',
    meta: 'Mounts, titles, achievements and rare collectibles · Ticks itself once Battle.net or Party Ledger sees the drop',
    categories: ['collectibles', 'optional'],
    season: 2,
    priority: 3,
    isNew: true,

    /* Every entry here is machine-checkable, which is what separates this
       section from a list of links.

         collectable    this task is satisfied by owning something, not by
                        doing something this week. Account-wide: it ticks on
                        every character at once and never resets.
         mountName      the mount journal's name for it. Matched on name
                        rather than id because the addon (C_MountJournal),
                        the Blizzard profile API and this file all agree on
                        the name and share no id space. Omit when the task
                        name is already the mount name.
         achievementId  ticks when the achievement is earned.
         itemId         the source item, for the Wowhead link only. Nothing
                        matches on it.

       To add one: give it a name that matches the mount journal exactly, or
       set mountName if the task should read differently, and it starts
       ticking itself with no other change anywhere. */
    tasks: [
      /* ── Raid mounts, weekly lockout ── */
      { id: 'hunt_alar', name: 'Ashes of Al\'ar',
        url: 'https://www.wowhead.com/item=32458/ashes-of-alar',
        desc: 'Defeat Kael\'thas Sunstrider in Tempest Keep for a weekly chance at the phoenix mount.',
        collectable: true, itemId: 32458,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_invincible', name: 'Invincible\'s Reins',
        url: 'https://www.wowhead.com/item=50818/invincibles-reins',
        desc: 'Defeat the Lich King on 25-player Heroic difficulty in Icecrown Citadel.',
        collectable: true, mountName: 'Invincible', itemId: 50818,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_mimiron', name: 'Mimiron\'s Head',
        url: 'https://www.wowhead.com/item=45693/mimirons-head',
        desc: 'Defeat Yogg-Saron with no Keepers assisting in 25-player Ulduar.',
        collectable: true, itemId: 45693,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_urzul', name: 'Shackled Ur\'zul',
        url: 'https://www.wowhead.com/item=152789/shackled-urzul',
        desc: 'Defeat Mythic Argus the Unmaker in Antorus, the Burning Throne.',
        collectable: true, itemId: 152789,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_onyxian', name: 'Reins of the Onyxian Drake',
        url: 'https://www.wowhead.com/item=49636/reins-of-the-onyxian-drake',
        desc: 'Defeat Onyxia in her lair. One of the most reliable weekly single-boss runs in the game.',
        collectable: true, mountName: 'Onyxian Drake', itemId: 49636,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_blazing', name: 'Reins of the Blazing Drake',
        url: 'https://www.wowhead.com/item=77067/reins-of-the-blazing-drake',
        desc: 'Defeat Madness of Deathwing in the Dragon Soul on any difficulty.',
        collectable: true, mountName: 'Blazing Drake', itemId: 77067,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_handmaiden', name: 'Life-Binder\'s Handmaiden',
        url: 'https://www.wowhead.com/item=77069/life-binders-handmaiden',
        desc: 'Defeat Madness of Deathwing on Heroic difficulty. Shares its lockout with the Blazing Drake, so one run rolls for both.',
        collectable: true, itemId: 77069,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_millagazor', name: 'Smoldering Egg of Millagazor',
        url: 'https://www.wowhead.com/item=69224/smoldering-egg-of-millagazor',
        desc: 'Defeat Ragnaros in the Firelands on Heroic difficulty.',
        collectable: true, mountName: 'Pureblood Fire Hawk', itemId: 69224,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_alysrazor', name: 'Flametalon of Alysrazor',
        url: 'https://www.wowhead.com/item=71665/flametalon-of-alysrazor',
        desc: 'Defeat Alysrazor in the Firelands. Drops on both difficulties, so the Normal clear is worth doing on the way past.',
        collectable: true, itemId: 71665,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },
      { id: 'hunt_azure', name: 'Reins of the Azure Drake',
        url: 'https://www.wowhead.com/item=43954/reins-of-the-azure-drake',
        desc: 'Defeat Malygos in The Eye of Eternity. Two mounts share the loot table, so every kill rolls on both.',
        collectable: true, mountName: 'Azure Drake', itemId: 43954,
        cadence: 'weekly', tags: ['tag-collectible','tag-raid','tag-optional'] },

      /* ── Dungeon mounts, daily lockout ── */
      { id: 'hunt_raven', name: 'Reins of the Raven Lord',
        url: 'https://www.wowhead.com/item=32768/reins-of-the-raven-lord',
        desc: 'Defeat Anzu in Heroic Sethekk Halls for a daily mount chance.',
        collectable: true, mountName: 'Raven Lord', itemId: 32768,
        cadence: 'daily', tags: ['tag-collectible','tag-optional'] },
      { id: 'hunt_warhorse', name: 'Fiery Warhorse\'s Reins',
        url: 'https://www.wowhead.com/item=30480/fiery-warhorses-reins',
        desc: 'Defeat Attumen the Huntsman in Karazhan. Daily lockout, and the fastest mount run in the game.',
        collectable: true, mountName: 'Fiery Warhorse', itemId: 30480,
        cadence: 'daily', tags: ['tag-collectible','tag-optional'] },
      { id: 'hunt_hawkstrider', name: 'Swift White Hawkstrider',
        url: 'https://www.wowhead.com/item=35513/swift-white-hawkstrider',
        desc: 'Defeat Kael\'thas Sunstrider in Magisters\' Terrace on Heroic difficulty.',
        collectable: true, itemId: 35513,
        cadence: 'daily', tags: ['tag-collectible','tag-optional'] },
      { id: 'hunt_bronze', name: 'Reins of the Bronze Drake',
        url: 'https://www.wowhead.com/item=43952/reins-of-the-bronze-drake',
        desc: 'Defeat Mal\'Ganis in Heroic Culling of Stratholme. Guaranteed if you also save Chrono-Lord Epoch on the timer.',
        collectable: true, mountName: 'Bronze Drake', itemId: 43952,
        cadence: 'daily', tags: ['tag-collectible','tag-optional'] },
      { id: 'hunt_blueproto', name: 'Reins of the Blue Proto-Drake',
        url: 'https://www.wowhead.com/item=44160/reins-of-the-blue-proto-drake',
        desc: 'Defeat Skadi the Ruthless in Heroic Utgarde Pinnacle.',
        collectable: true, mountName: 'Blue Proto-Drake', itemId: 44160,
        cadence: 'daily', tags: ['tag-collectible','tag-optional'] },

      /* ── World and rare spawns ── */
      { id: 'hunt_onyx', name: 'Heavenly Onyx Cloud Serpent',
        url: 'https://www.wowhead.com/item=87771/reins-of-the-heavenly-onyx-cloud-serpent',
        desc: 'Hunt the Sha of Anger in Kun-Lai Summit for this rare world-boss mount.',
        collectable: true, itemId: 87771,
        cadence: 'weekly', tags: ['tag-collectible','tag-world','tag-optional'] },
      { id: 'hunt_aeonaxx', name: 'Phosphorescent Stone Drake',
        url: 'https://www.wowhead.com/item=63042/reins-of-the-phosphorescent-stone-drake',
        desc: 'Find and defeat the rare spawn Aeonaxx in Deepholm.',
        collectable: true, itemId: 63042,
        cadence: 'longterm', tags: ['tag-collectible','tag-world','tag-optional'] },
      { id: 'hunt_tlp', name: 'Time-Lost Proto-Drake',
        url: 'https://www.wowhead.com/item=44168/reins-of-the-time-lost-proto-drake',
        desc: 'Patrol the Storm Peaks rare-spawn routes and defeat the Time-Lost Proto-Drake.',
        collectable: true, itemId: 44168,
        cadence: 'longterm', tags: ['tag-collectible','tag-world','tag-optional'] },
      { id: 'hunt_northwind', name: 'Reins of the Drake of the North Wind',
        url: 'https://www.wowhead.com/item=63040/reins-of-the-drake-of-the-north-wind',
        desc: 'Defeat Altairus in Vortex Pinnacle. Daily lockout and a short run.',
        collectable: true, mountName: 'Drake of the North Wind', itemId: 63040,
        cadence: 'daily', tags: ['tag-collectible','tag-world','tag-optional'] },

      /* ── Achievements and titles ── */
      { id: 'hunt_insane', name: 'The Insane title',
        url: 'https://www.wowhead.com/achievement=2336/insane-in-the-membrane',
        desc: 'Complete the required legacy reputation grinds for one of Azeroth\'s most notorious titles.',
        achievementId: 2336,
        cadence: 'longterm', tags: ['tag-collectible','tag-optional'] },
      { id: 'hunt_loremaster', name: 'The Loremaster title',
        url: 'https://www.wowhead.com/achievement=7520/the-loremaster',
        desc: 'Complete the continent-wide quest achievements across modern Azeroth.',
        achievementId: 7520,
        cadence: 'longterm', tags: ['tag-collectible','tag-world','tag-optional'] },
      { id: 'hunt_longstrange', name: 'What a Long, Strange Trip It\'s Been',
        url: 'https://www.wowhead.com/achievement=2144/what-a-long-strange-trip-its-been',
        desc: 'Complete the holiday meta-achievements to earn the Violet Proto-Drake. A full calendar year to finish, so start it whenever you notice it.',
        achievementId: 2144,
        cadence: 'longterm', tags: ['tag-collectible','tag-world','tag-optional'] },
      { id: 'hunt_naxx', name: 'Glory of the Raider',
        url: 'https://www.wowhead.com/achievement=2138/glory-of-the-raider-25-player',
        desc: 'Complete the classic raid achievement set for the Plagued Proto-Drake.',
        achievementId: 2138,
        cadence: 'longterm', tags: ['tag-collectible','tag-raid','tag-optional'] },

      /* ── Season 2 collectables, from elsewhere on this list ── */
      { id: 'hunt_giganto', name: 'Giganto Manis',
        url: 'https://www.icy-veins.com/wow/midnight-season-2-guide',
        desc: 'The Season 2 Delve meta-achievement mount, from "Glory of the Midnight Delver". Tracked here as well as in the Delves section so it shows up in a collection sweep.',
        collectable: true,
        cadence: 'longterm', tags: ['tag-collectible','tag-121','tag-optional'] },
      { id: 'hunt_isleserpent', name: 'Sea-Dwelling Isle Serpent',
        url: 'https://www.icy-veins.com/wow/midnight-season-2-guide',
        desc: 'The Tokka\'s Crew friendship track reward. Fishing-flavoured and entirely solo, so it advances on weeks when nothing else does.',
        collectable: true,
        cadence: 'longterm', tags: ['tag-collectible','tag-121','tag-optional'] },
    ]
  },
