...
const SECTIONS = [
...

  {
    ...
    meta: 'Mounts, titles, achievements and rare collectibles · Every objective links to a completion guide',
    ...
    tasks: [
      ...
      { id: 'hunt_longstrange', name: 'What a Long, Strange Trip It\'s Been',
        ...
        desc: 'Complete the holiday meta-achievements to earn the Violet Proto-Drake.',
        cadence: 'longterm', tags: ['tag-collectible','tag-world','tag-optional'] },
